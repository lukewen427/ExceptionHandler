...
public interface TicketRemote {
    ...
    /** Create an application ID for accessing data from a specific user */
    com.connexience.server.model.security.ApplicationTicket createApplicationTicket(String applicationId) throws ConnexienceException;
