/*
 * WriteByServiceEvent.java
 */

package com.connexience.server.model.logging.events;

/**
 * This class logs the fact that a piece of data has been written by a workflow
 * service.
 * @author hugo
 */
public class WriteByServiceEvent extends DataEvent {
    /** Service ID */
  ...
  public WriteByServiceEvent()
  {
  }

  public WriteByServiceEvent(Long timestamp, String principalId, String objectId, String objectType, String versionId, String principalName, String objectName) {
